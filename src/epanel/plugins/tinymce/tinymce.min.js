...
function setMCE(selector){
    ...
    tinymce.init({
        ...
        theme: 'modern',
        skin:'epanel',
        plugins : "preview, fullscreen, print, directionality, lists, textcolor, contextmenu, table, paste, wordcount, contextmenu, code, link, hr, image, media ",
        directionality : 'rtl',
        menu: {
            file: {title: 'File', items: 'code preview | print'},
            edit: {title: 'Edit', items: 'undo redo | cut copy paste pastetext | selectall'},
            insert: {title: 'Insert', items: 'image link media | hr'},
            view: {title: 'View', items: 'visualaid code | preview fullscreen |  print'},
            format: {title: 'Format', items: 'bold italic underline strikethrough superscript subscript | formats | removeformat'},
        },
        toolbar1:'print fullscreen preview | undo redo | ltr rtl |  alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | hr link table image media',
        toolbar2:' fontsizeselect fontselect | bold italic underline | forecolor backcolor',
        contextmenu: "copy paste cut link | bold italic underline | inserttable ",
        branding: false,
        height : 350,
