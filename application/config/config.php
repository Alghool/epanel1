...
if($_SERVER['SERVER_NAME'] == "localhost"){
    $config['base_url'] = 'http://localhost/epanel/';
}else{
    $config['base_url'] = "";
}
...
$config['sess_cookie_name'] = 'epanel_session';
...
$config['csrf_token_name'] = 'csrf_epanel';
$config['csrf_cookie_name'] = 'csrf_epanel';
...
*/
if(!function_exists('my_own_controllers')){
